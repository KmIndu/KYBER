/**
 * GuidedTour — Spotlight walkthrough that highlights actual page elements
 * with arrows pointing to them. No blurred background modal.
...
const TOUR_STORAGE_KEY = "kyber_tour_completed";

const STEPS = [
  { target: "tour-quickstart", label: "Start here — upload a schema or describe your data" },
  { target: "tour-stats", label: "Your generation stats at a glance" },
  { target: "tour-tip", label: "Yoda's tips to guide your journey" },
  { target: "tour-ask-yoda", label: "Need help? Ask Yoda — your AI assistant for KYBER questions and synthetic data guidance" },
];
