/**
 * Reference Tab — upload screenshots, schema images, BRD snippets,
 * or API docs for OCR extraction and synthetic data generation.
 * Extracted from ReferencePage for the unified home layout.
 */
